...
router.put('/:cardId/likes', celebrate({ params: Joi.string().length(24).required() }), likeCard);
router.delete('/:cardId/likes', celebrate({ params: Joi.string().length(24).required() }), dislikeCard);
